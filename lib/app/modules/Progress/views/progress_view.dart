    ...
    return RepaintBoundary(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // A primary bottom-nav destination - never a back arrow, even
          // when it was reached via a push that leaves a Navigator entry
          // behind it (see diet_and_exercise_screen's same fix).
